 ...
 * @param displayPath - base-relative or user-global instruction path.
 * @returns `user-global`, `.`, or the containing base-relative directory.
 */
 ...
 * directory path or file name can contain.
 * @param directory - `user-global`, `.`, or a base-relative directory.
